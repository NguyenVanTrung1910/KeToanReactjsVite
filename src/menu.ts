	...
	listPages: {
		...
		subMenu: {
			listPages: {
				id: 'listBoxedaa',
				text: 'Boxed List',
				path: '/list-pagessss/boxed-list',
				icon: 'ViewArray',
				subMenu: {
					listPages: {
						id: 'trungaa',
						text: 'Boxed Ltrungist',
						path: '/list-trungsss/boxed-list1',
						icon: 'ViewArray',
					},
					listPages1: {
						id: 'trungaa1',
						text: 'Boxed Ltrungist1',
						path: '/list-trungsss/boxed-list2',
						icon: 'ViewArray',
					},
					listPages2: {
						id: 'trungaa2',
						text: 'Boxed Ltrungist2',
						path: '/list-trungsss/boxed-list',
						icon: 'ViewArray',
					},
				},
			},
