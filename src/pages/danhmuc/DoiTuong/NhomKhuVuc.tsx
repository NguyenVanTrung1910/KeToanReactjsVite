...
const NhomKhuVuc = () => {
    ...
    return (
        ...
        <PageWrapper title={demoPagesMenu.sales.subMenu.dashboard.text}>
            <SubHeaderDM link1='' link2='/danhmuc/danhmuc/loai=DANHMUCNHOMKHUVUC' title1='Danh Mục' title2='Danh Mục Nhóm Khu Vực'
                listButton={<AddAndEditModal
                    nameButton='Thêm mới'
                    title='Danh Mục Nhóm Khu Vực'
                    content={<NhomKhuVucForm idItem={idItemCurrent.current} reloadGrid={dataGridRef.current?.reloadGrid} setOpenModal={setIsOpenModal} />} isOpen={isOpenModal} setIsOpen={setIsOpenModal}
                    includeButton={true} />}
                ...
                <div className='row'>
                    <div className='col-xxl-12'>
                        <DataTable
                            ...
                            apiUrlGetTitle={`/danhmuc/danhmuc?loai=DANHMUCNHOMKHUVUC`}
                            loai='DANHMUCNHOMKHUVUC'
