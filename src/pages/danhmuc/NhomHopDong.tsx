...
import NhomHopDongForm from './Form/NhomHopDongForm';
const DanhMucDoiTuong = () => {
    ...
    return (<>
        ...
        <PageWrapper title={demoPagesMenu.sales.subMenu.dashboard.text}>
                <SubHeaderDM link1='' link2='/danhmuc/danhmuc/loai=DANHMUCNHOMHOPDONG' title1='Danh Mục' title2='Danh Mục Nhóm Hợp Đồng'
                    listButton={<AddAndEditModal
                        nameButton='Thêm mới'
                        title='Danh Mục Nhóm Hợp Đồng'
                        content={<NhomHopDongForm idItem={idItemCurrent.current} reloadGrid={dataGridRef.current?.reloadGrid} setOpenModal={setIsOpenModal} />} isOpen={isOpenModal} setIsOpen={setIsOpenModal}
                        includeButton={true} />}
                    ...
                    <div className='row'>
                        <div className='col-xxl-12'>
                            <DataTable
                                ...
                                apiUrlGetTitle={`/danhmuc/danhmuc?loai=DANHMUCNHOMHOPDONG`}
                                loai='DANHMUCNHOMHOPDONG'
                                keyField='ID'
                                ref={dataGridRef}
