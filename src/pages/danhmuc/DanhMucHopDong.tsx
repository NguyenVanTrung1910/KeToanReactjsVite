...
const DanhMucHopDong = () => {
    ...
    return (<>
        ...
        <PageWrapper title={demoPagesMenu.sales.subMenu.dashboard.text}>
                <SubHeaderDM link1='' link2='/danhmuc/danhmuc/loai=DANHMUCHOPDONG' title1='Danh Mục' title2='Danh Mục Hợp Đồng'
                    ...
                    <div className='row'>
                        <div className='col-xxl-12'>
                            <DataTable
                                ...
                                apiUrlGetTitle={`/danhmuc/danhmuc?loai=DANHMUCHOPDONG`}
                                loai='DANHMUCHOPDONG'
                                keyField='ID'
                                ref={dataGridRef}
